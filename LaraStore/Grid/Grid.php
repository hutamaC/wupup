...
class Grid{
	...
	*/
	...
	public function bridQuery(){

		return $this->brid? $this->bridHandle() : $this;

	}

	public function bridHandle(){

		// dd($this->brid);
		

		$this->query 		= $this->query->where('brand_id',$this->brid );
	...
	public function searchQuery(){
		...
		return $this->search? $this->searchHandle() : $this;

	}

	public function searchHandle(){

		$this->query 		=  $this->query->where('goods_name','like','%'.$this->search.'%' );
