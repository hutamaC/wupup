...
trait BaseRepository{
    ...
    */
    ...
    |-------------------------------------------------------------------------------
    |
    |  获取分类下的搜索的商品列表   9.12 新增
    |
    |-------------------------------------------------------------------------------
    */
    public function goods_search_list($search){
        return $this->presenter()->goods($search)->handle();
    }
    ...
    |-------------------------------------------------------------------------------
    */
    public function goods_cat($search){
        return $this->presenter()->getchildren($search)->handle();
    }
