    ...
    <head>
      ...
      <style type="text/css">
        @font-face {
            ...
            font-style: normal;
            font-weight: 400;
              src: url(/front/materialize/iconfont/MaterialIcons-Regular.eot); /* For IE6-8 */
              src: local('Material Icons'),
                   local('MaterialIcons-Regular'),
                   url(/front/materialize/iconfont/MaterialIcons-Regular.woff2) format('woff2'),
                   url(/front/materialize/iconfont/MaterialIcons-Regular.woff) format('woff'),
                   url(/front/materialize/iconfont/MaterialIcons-Regular.ttf) format('truetype');
        }
        .material-icons {
          font-family: 'Material Icons';
          font-weight: normal;
