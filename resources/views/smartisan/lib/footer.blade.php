...
<!-- <div class="footer">
	...
	<div class="footer-content">
	 <div class="row">
	 	@include('smartisan.lib.help')
	 </div>
	</div>
		@include('smartisan.lib.bottom')
	</div>
</div> -->
    ...
    <div class="fatfooter">
        <div class="wrapper">
            <div class="fatft-service">
                <div class="item">
                    <a href="">
                        <img src="{{url('front/smartisan/images/ft-ser1.png')}}" alt="" class="ico" />
                        <span>品质保障</span>
                    </a>
                </div>
                <div class="item">
                    <a href="">
                        <img src="{{url('front/smartisan/images/ft-ser2.png')}}" alt="" class="ico" />
                        <span>七天无理由退换货</span>
                    </a>
                </div>
                <div class="item">
                    <a href="">
                        <img src="{{url('front/smartisan/images/ft-ser3.png')}}" alt="" class="ico" />
                        <span>特色服务体验</span>
                    </a>
                </div>
                <div class="item">
                    <a href="">
                        <img src="{{url('front/smartisan/images/ft-ser4.png')}}" alt="" class="ico" />
                        <span>帮助中心</span>
                    </a>
                </div>
            </div>
