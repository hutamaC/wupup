		...
		<div class="panel panel-goods">
			...
			<table class="table table-cart" v-else>
				...
				<tr 
					...
					<td>
						...
						<img v-bind:src="cart.thumb" v-bind:alt="cart.goods_name"  class="cart-thumb"  v-if="cart.thumb">
						<img v-bind:src="'http://albft01.s3-ap-southeast-1.amazonaws.com/images/gray/'+cart.goods_name+'.jpg'" v-bind:alt="cart.goods_name" class="cart-thumb" v-if="!cart.thumb">
			...
			<div class="row">
				...
				<div class="shipping-info">
					...
					<a href="{{url('checkout')}}" class="ls-btn-info" v-if="rows.cart_checked_amount > 0">预定</a>
				</div>
		    </div><!--/footer-bb-->
			</div><!--/bottom-->
	   </div><!--/panel-->
