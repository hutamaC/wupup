    ...
    */
    public function store(){
        ...
        $rules  = [
                        ...
                        'cat_id'    =>['required',new CategoryRule],
                        'brand_id'  => 'required',
        ...
        $msg   = [
                        'goods_name.required'=>'商品名称必须',
                        'goods_name.unique' =>'商品名称重复',
                        'cat_id.required'   =>'分类必须',
                        'brand_id.required' =>'品牌必须',
                        // 'diy_url.unique'    =>'商品自定义链接必须',
                        'shop_price.required'=>'商品价格必须',
                        'goods_weight.required'=>'商品重量属性必须',
                        'original_imgs.image'=>'上传的商品相册必须是图片',
                        'keywords.required'=>'关键词必须',
        ];
